...
@section('content')
    ...
    <div class="mt-10 w-auto">
        <div class="bg-gradient-to-b from-blue-800 to-blue-600 h-80 rounded-lg"></div>
        <div class="max-w-5xl mx-auto px-6 sm:px-6 lg:px-8 mb-12">
            <div class="bg-gray-900 w-full shadow rounded-lg p-8 sm:p-12 -mt-72 border-2 border-blue-700">
                ...
                <form action="{{ route('admin.categories.store') }}" method="post">
                    ...
                    <div>
                        <div class="w-full flex flex-col mt-8">
                            ...
                            <textarea type="text"
                                class="h-20 text-base leading-none text-gray-50 p-3 focus:outline-none focus:border-blue-700 mt-4 bg-gray-800 border-0 rounded"></textarea>
                        </div>
                    </div>
