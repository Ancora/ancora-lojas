        ...
        <div class="w-screen mt-20">
            <div class="w-11/12 mx-auto">
                <button type="submit"
                    ...
                    <a href="{{ route('admin.colors.create') }}">Cadastrar Cor</a>
                </button>
            </div>
            ...
            @if (is_null($colors) || $colors->count() == 0)
                <div class="w-11/12 mx-auto">
                            ...
                            <thead class="block md:table-header-group">
                                <tr
                                    ...
                                    <th class="bg-gray-600 px-3 py-2 text-white font-bold text-center block md:table-cell">
                                        ID</th>
                                    <th class="bg-gray-600 py-2 text-white font-bold text-left block md:table-cell">
                                        Cor</th>
                                    <th class="bg-gray-600 py-2 text-white font-bold text-left block md:table-cell">
                                        Condição
                                    </th>
                                    <th class="bg-gray-600 text-white font-bold text-left block md:table-cell">
                                        Componente</th>
                                    <th class="bg-gray-600 text-white font-bold text-left block md:table-cell">
                                        Fabricante</th>
                            ...
                            <tbody class="block md:table-row-group">
                                @foreach ($colors as $color)
                                    <tr class="bg-transparent even:bg-gray-500 md:border-none block md:table-row">
                                        ...
                                        <td class="py-2 text-left text-gray-100 block md:table-cell"><span
