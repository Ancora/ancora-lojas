    ...
    <div class="mt-10 w-screen">
        ...
        <div class="w-10/12 mx-auto">
            <div class="bg-gray-900 w-full shadow rounded-b-3xl p-8 sm:p-12 -mt-72 border-2 border-blue-800">
                <p class="text-3xl font-bold leading-7 text-center text-white">Editar Elemento</p>
                {{-- Form --}}
                <form action="{{ route('admin.elements.update', $element->id) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="w-full flex flex-col md:flex-row mt-4">
                        ...
                        <div class="w-full md:w-2/4 mr-2 flex flex-col">
                            ...
                            <input type="text" name="name" value="{{ old('name', $element->name) }}"
                        ...
                        <div class="w-full md:w-2/4 flex flex-col">
                            ...
                            <input type="text" name="factor" value="{{ old('factor', $element->factor) }}"
                                class="leading-none text-gray-50 p-3 focus:outline-none focus:border-blue-700 mt-4 border-0 bg-gray-800 rounded" />
                            @error('factor')
                                <span class="text-red-600">
                                    {{ $message }}
