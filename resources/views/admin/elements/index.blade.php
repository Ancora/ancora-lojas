        ...
        <div class="w-screen mt-20">
            <div class="w-11/12 mx-auto">
                <button type="submit"
                    ...
                    <a href="{{ route('admin.elements.create') }}">Cadastrar Elemento</a>
                </button>
            </div>
                            ...
                            <thead class="block md:table-header-group">
                                <tr
                                    ...
                                    <th class="bg-gray-600 px-3 py-2 text-white font-bold text-center block md:table-cell">
                                        ID</th>
                                    <th class="bg-gray-600 px-20 py-2 text-white font-bold text-left block md:table-cell">
                                        Elemento</th>
                                    <th class="bg-gray-600 px-3 py-2 text-white font-bold text-left block md:table-cell">
                                        Fator
                                    </th>
                                ...
                                @foreach ($elements as $element)
                                    <tr class="bg-transparent even:bg-gray-500 md:border-none block md:table-row">
                                        <td class="p-2 px-3 text-center text-gray-100 block md:table-cell"><span
                                                class="flex justify-start  w-1/6 md:hidden font-bold">ID:
                                            </span>{{ $element->id }}
                                        </td>
                                        <td class="px-20 py-2 text-left text-gray-100 block md:table-cell"><span
                                                class="flex justify-start  w-3/6 md:hidden font-bold">Nome:
                                            </span>{{ $element->name }}
                                        </td>
                                        <td class="px-3 py-2 text-left text-gray-100 block md:table-cell"><span
                                                class="flex justify-start w-1/6 md:hidden font-bold">Descrição:
                                            </span>{{ $element->factor }}
                                        </td>
                                        <td class="p-2 text-left text-gray-100 md:table-cell">
                                            ...
                                            <span class="flex sm:justify-evenly">
                                                <button type="submit"
                                                    ...
                                                    <a
                                                        href="{{ route('admin.elements.edit', ['element' => $element->id]) }}">
                                                        Editar
                                                    </a>
                                                </button>
                                                <button
                                                    class="bg-red-500 hover:bg-red-700 text-white font-bold py-1 px-2 border border-red-500 rounded">
                                                    <a href="{{ route('admin.elements.destroy', $element->id) }}">
                                                        Excluir
                                                    </a>
                                                </button>
                                            </span>
